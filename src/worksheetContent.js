...
// Curriculum reference: each grade's list below is the school's official
// topic set (see project notes). Every existing generator keeps its original
// `id` unchanged — several helper functions (ODD_ONE_OUT_TOPIC_IDS,
// buildTraceLetters's "alphabet" check) match against these ids literally,
// so renaming one silently breaks odd-one-out / picture-shadow / trace /
// color-by-numbers for that topic. Curriculum topics with no generator yet
// are listed as `comingSoon: true` placeholders — visible in the UI (so the
...
export const TOPICS = [
  ...
  // ── Grade 3 ──────────────────────────────────────────────────────────────
  { id: "g3_numbers", emoji: "🔢", name: "Numbers 1-100", desc: "Brojevi 1–100", grade: "3" },
  { id: "g3_time", emoji: "🕐", name: "Time", desc: "Vreme — koliko je sati", grade: "3" },
  { id: "g3_days_week", emoji: "📅", name: "Days of the week", desc: "Dani u nedelji", grade: "3" },
  { id: "adjectives", emoji: "📏", name: "Adjectives (appearance) + has got/hasn't got", desc: "Pridevi — Stars & Heroes", grade: "3" },
  { id: "sea_world", emoji: "🌊", name: "At the ocean", desc: "Podvodni svet — Nemo i prijatelji", grade: "3" },
  { id: "g3_can_cant", emoji: "💪", name: "Can & Can't", desc: "Šta umem, a šta ne", grade: "3" },
  { id: "places_in_town", emoji: "🏙️", name: "Places in town", desc: "Mesta u gradu — Stars & Heroes", grade: "3" },
  { id: "g3_this_that", emoji: "👉", name: "This/That/These/Those", desc: "Pokazne zamenice", grade: "3" },
  { id: "prepositions", emoji: "📦", name: "Prepositions of place", desc: "Gde je Mickey? in/on/under…", grade: "3" },
  { id: "g3_food_meals", emoji: "🍽️", name: "Food and meals + Food groups", desc: "Hrana i obroci — grupe namirnica", grade: "3" },
  { id: "g3_there_is_are", emoji: "📍", name: "There is/There are", desc: "There is / There are", grade: "3" },
  { id: "g3_seasons_weather", emoji: "☀️", name: "Seasons and the weather + Seasonal activities", desc: "Godišnja doba i sezonske aktivnosti", grade: "3" },
  { id: "g3_my_day", emoji: "⏰", name: "My day (Daily routine)", desc: "Moj dan — dnevna rutina", grade: "3" },
  { id: "g3_parts_of_day", emoji: "🌅", name: "Parts of the day and Prepositions of time (at, in, on)", desc: "Delovi dana — predlozi vremena", grade: "3" },
  { id: "present_simple_3rd", emoji: "🔄", name: "Present Simple Tense", desc: "Mickey plays, Minnie reads…", grade: "3" },
  { id: "g3_jobs", emoji: "👩‍⚕️", name: "Jobs", desc: "Zanimanja", grade: "3" },
  { id: "g3_after_school", emoji: "🎨", name: "After school", desc: "Posle škole", grade: "3" },
  ...
  { id: "g4_transport", emoji: "🚌", name: "Transport", desc: "Prevoz", grade: "4" },
  { id: "sports", emoji: "⚽", name: "Sports", desc: "Sportovi — Mickey & Heroes", grade: "4" },
  { id: "g4_seasons_weather_times", emoji: "☀️", name: "Seasons, weather and times of day", desc: "Godišnja doba, vreme i doba dana", grade: "4" },
  { id: "g4_question_words", emoji: "❓", name: "Question words (Who, What, Where, When, How)", desc: "Upitne reči", grade: "4" },
  { id: "g4_subject_object_pronouns", emoji: "👤", name: "Subject Pronouns and Object Pronouns", desc: "Lične i objekatske zamenice", grade: "4" },
  { id: "g4_prepositions_time", emoji: "🕐", name: "Prepositions of time (at, in, on)", desc: "Predlozi vremena", grade: "4" },
  { id: "g4_places_in_town", emoji: "🏙️", name: "Places in town", desc: "Mesta u gradu", grade: "4" },
  { id: "present_continuous", emoji: "🏃", name: "Present Continuous", desc: "Mickey is running — is/am/are + -ing", grade: "4" },
  { id: "g4_clothes", emoji: "👕", name: "Clothes", desc: "Odeća", grade: "4" },
  { id: "g4_directions", emoji: "🧭", name: "Directions", desc: "Pravci — levo, desno, pravo", grade: "4" },
  { id: "g4_months_celebrations", emoji: "🎉", name: "Months and Celebrations", desc: "Meseci i praznici", grade: "4" },
  { id: "g4_adverbs_frequency", emoji: "🔁", name: "Adverbs of frequency", desc: "always, usually, sometimes…", grade: "4" },
  { id: "g4_ordinal_numbers", emoji: "🥇", name: "Ordinal numbers", desc: "first, second, third…", grade: "4" },
  { id: "g4_school_subjects", emoji: "📖", name: "School subjects", desc: "Školski predmeti", grade: "4" },
  // Bonus grade-4 content already built (not in the official list above, kept reachable):
  ...
  // ── Grade 5 (beyond the current curriculum list, kept unchanged) ────────
  ...
  // ── Grade 6 (beyond the current curriculum list, kept unchanged) ────────
...
const ODD_ONE_OUT_TOPIC_IDS = [
  ...
  "g4_transport", "g4_seasons_weather_times", "g4_places_in_town", "g4_directions",
  "g4_months_celebrations", "g4_school_subjects",
];
...
export const TOPIC_DATA = {
  ...
  // ── Grade 3 curriculum additions (batch 3) ──────────────────────────────
  g3_numbers: {
    generate(count) {
      const all = [
        { word: "ten", emoji: "🔟", sr: "deset" }, { word: "twenty", emoji: "2️⃣0️⃣", sr: "dvadeset" },
        { word: "thirty", emoji: "3️⃣0️⃣", sr: "trideset" }, { word: "forty", emoji: "4️⃣0️⃣", sr: "četrdeset" },
        { word: "fifty", emoji: "5️⃣0️⃣", sr: "pedeset" }, { word: "sixty", emoji: "6️⃣0️⃣", sr: "šezdeset" },
        { word: "seventy", emoji: "7️⃣0️⃣", sr: "sedamdeset" }, { word: "eighty", emoji: "8️⃣0️⃣", sr: "osamdeset" },
        { word: "ninety", emoji: "9️⃣0️⃣", sr: "devedeset" }, { word: "one hundred", emoji: "💯", sr: "sto" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 10));
      return {
        type: "listen-circle",
  ...
  g3_time: {
    generate(count) {
      const all = [
        { word: "o'clock", emoji: "🕐", sr: "tačno / puni sat" }, { word: "half past", emoji: "🕜", sr: "i po" },
        { word: "quarter past", emoji: "🕒", sr: "i petnaest" }, { word: "quarter to", emoji: "🕡", sr: "manje petnaest" },
        { word: "morning", emoji: "🌅", sr: "jutro" }, { word: "afternoon", emoji: "🌤️", sr: "popodne" },
        { word: "evening", emoji: "🌆", sr: "veče" }, { word: "night", emoji: "🌙", sr: "noć" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 8));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže izraz za vreme na engleskom. Zaokruži odgovarajuću sličicu! 🕐",
        teacherNote: "Izgovorite izraz 2–3 puta. Deca zaokružuju sličicu.",
        items,
      };
    },
  },
  ...
  g3_days_week: {
    generate(count) {
      const all = [
        { word: "Monday", emoji: "1️⃣", sr: "ponedeljak" }, { word: "Tuesday", emoji: "2️⃣", sr: "utorak" },
        { word: "Wednesday", emoji: "3️⃣", sr: "sreda" }, { word: "Thursday", emoji: "4️⃣", sr: "četvrtak" },
        { word: "Friday", emoji: "5️⃣", sr: "petak" }, { word: "Saturday", emoji: "6️⃣", sr: "subota" },
        { word: "Sunday", emoji: "7️⃣", sr: "nedelja" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 7));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže dan u nedelji na engleskom. Zaokruži odgovarajući dan! 📅",
        teacherNote: "Izgovorite dan 2–3 puta. Deca zaokružuju odgovarajući broj (Monday = 1. dan).",
        items,
      };
    },
  },
  ...
  g3_can_cant: {
    generate(count) {
      const pool = shuffle([
        { sentence: "Penguins ___ fly.", answer: "can't", hint: "(nemogućnost)" },
        { sentence: "Monkeys ___ climb trees.", answer: "can", hint: "(sposobnost)" },
        { sentence: "I ___ speak French.", answer: "can't", hint: "(nemogućnost)" },
        { sentence: "My dad ___ drive a car.", answer: "can", hint: "(sposobnost)" },
        { sentence: "Babies ___ walk.", answer: "can't", hint: "(nemogućnost)" },
        { sentence: "Eagles ___ see very well.", answer: "can", hint: "(sposobnost)" },
        { sentence: "Turtles ___ run fast.", answer: "can't", hint: "(nemogućnost)" },
        { sentence: "Dolphins ___ swim fast.", answer: "can", hint: "(sposobnost)" },
        { sentence: "I ___ play the piano.", answer: "can", hint: "(sposobnost)" },
        { sentence: "Cows ___ fly.", answer: "can't", hint: "(nemogućnost)" },
      ]).slice(0, Math.min(count, 10));
      return {
        type: "fillin",
        instruction: 'Popuni rečenicu sa "can" ili "can\'t".',
  ...
  g3_this_that: {
    generate(count) {
      const pool = shuffle([
        { sentence: "___ is my book. (here)", answer: "This" },
        { sentence: "___ is your pencil. (there)", answer: "That" },
        { sentence: "___ are my shoes. (here)", answer: "These" },
        { sentence: "___ are her toys. (there)", answer: "Those" },
        { sentence: "___ is my dog. (here)", answer: "This" },
        { sentence: "___ is his car. (there)", answer: "That" },
        { sentence: "___ are our books. (here)", answer: "These" },
        { sentence: "___ are their bikes. (there)", answer: "Those" },
  ...
  g3_food_meals: {
    generate(count) {
      const all = [
        { word: "breakfast", emoji: "🍳", sr: "doručak" }, { word: "lunch", emoji: "🍱", sr: "ručak" },
        { word: "dinner", emoji: "🍽️", sr: "večera" }, { word: "snack", emoji: "🍪", sr: "užina" },
        { word: "fruit", emoji: "🍎", sr: "voće" }, { word: "vegetables", emoji: "🥦", sr: "povrće" },
        { word: "dairy", emoji: "🥛", sr: "mlečni proizvodi" }, { word: "meat", emoji: "🍗", sr: "meso" },
        { word: "grains", emoji: "🌾", sr: "žitarice" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 9));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže obrok ili grupu namirnica na engleskom. Zaokruži odgovarajuću sličicu! 🍽️",
        teacherNote: "Izgovorite reč 2–3 puta. Deca zaokružuju sličicu.",
        items,
      };
    },
  ...
  g3_there_is_are: {
    generate(count) {
      const pool = shuffle([
        { sentence: "___ a cat in the garden.", answer: "There is" },
        { sentence: "___ three books on the table.", answer: "There are" },
        { sentence: "___ a park near my house.", answer: "There is" },
        { sentence: "___ two dogs in the yard.", answer: "There are" },
        { sentence: "___ a lamp in my room.", answer: "There is" },
        { sentence: "___ five apples in the basket.", answer: "There are" },
        { sentence: "___ a school in our town.", answer: "There is" },
        { sentence: "___ many students in the class.", answer: "There are" },
      ]).slice(0, Math.min(count, 8));
      return {
        type: "fillin",
  ...
  g3_seasons_weather: {
    generate(count) {
      const all = [
        { word: "spring", emoji: "🌸", sr: "proleće" }, { word: "summer", emoji: "☀️", sr: "leto" },
        { word: "autumn", emoji: "🍂", sr: "jesen" }, { word: "winter", emoji: "❄️", sr: "zima" },
        { word: "skiing", emoji: "⛷️", sr: "skijanje" }, { word: "swimming", emoji: "🏊", sr: "plivanje" },
        { word: "picking apples", emoji: "🍏", sr: "branje jabuka" }, { word: "planting flowers", emoji: "🌷", sr: "sađenje cveća" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 8));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže godišnje doba ili sezonsku aktivnost na engleskom. Zaokruži odgovarajuću sličicu! ☀️",
        teacherNote: "Izgovorite reč 2–3 puta. Deca zaokružuju sličicu.",
        items,
      };
    },
  ...
  g3_my_day: {
    generate(count) {
      const all = [
        { word: "wake up", emoji: "⏰", sr: "budi se" }, { word: "get dressed", emoji: "👕", sr: "oblači se" },
        { word: "have breakfast", emoji: "🍳", sr: "doručkuje" }, { word: "go to school", emoji: "🎒", sr: "ide u školu" },
        { word: "do homework", emoji: "📝", sr: "radi domaći" }, { word: "have dinner", emoji: "🍽️", sr: "večera" },
        { word: "brush teeth", emoji: "🪥", sr: "pere zube" }, { word: "go to bed", emoji: "🛏️", sr: "ide na spavanje" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 8));
      return {
        type: "listen-circle",
  ...
  g3_parts_of_day: {
    generate(count) {
      const pool = shuffle([
        { sentence: "I have breakfast ___ the morning.", answer: "in" },
        { sentence: "I go to bed ___ night.", answer: "at" },
        { sentence: "We watch TV ___ the evening.", answer: "in" },
        { sentence: "School starts ___ 8 o'clock.", answer: "at" },
        { sentence: "My birthday is ___ May.", answer: "in" },
        { sentence: "We have lunch ___ noon.", answer: "at" },
        { sentence: "I do my homework ___ the afternoon.", answer: "in" },
        { sentence: "The shop opens ___ 9 o'clock.", answer: "at" },
      ]).slice(0, Math.min(count, 8));
      return {
        type: "fillin",
        instruction: 'Popuni rečenicu sa "at" ili "in".',
        wordBank: ["at", "in"],
        items: pool,
      };
    },
  ...
  g3_jobs: {
    generate(count) {
      const all = [
        { word: "teacher", emoji: "🧑‍🏫", sr: "učitelj/ica" }, { word: "doctor", emoji: "🧑‍⚕️", sr: "lekar/ka" },
        { word: "police officer", emoji: "👮", sr: "policajac" }, { word: "firefighter", emoji: "🧑‍🚒", sr: "vatrogasac" },
        { word: "farmer", emoji: "🧑‍🌾", sr: "farmer" }, { word: "chef", emoji: "🧑‍🍳", sr: "kuvar/ica" },
        { word: "driver", emoji: "🚗", sr: "vozač" }, { word: "dentist", emoji: "🦷", sr: "zubar/ka" },
        { word: "vet", emoji: "🐾", sr: "veterinar" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 9));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže zanimanje na engleskom. Zaokruži odgovarajuću sličicu! 👩‍⚕️",
        teacherNote: "Izgovorite zanimanje 2–3 puta. Deca zaokružuju sličicu.",
        items,
      };
    },
  },
  ...
  g3_after_school: {
    generate(count) {
      const all = [
        { word: "homework", emoji: "📝", sr: "domaći" }, { word: "playing outside", emoji: "🏃", sr: "igra napolju" },
        { word: "sports practice", emoji: "⚽", sr: "trening" }, { word: "music lesson", emoji: "🎵", sr: "čas muzike" },
        { word: "art class", emoji: "🎨", sr: "likovno" }, { word: "tutoring", emoji: "📚", sr: "dodatna nastava" },
        { word: "playing with friends", emoji: "👫", sr: "druženje sa drugarima" }, { word: "watching cartoons", emoji: "📺", sr: "gledanje crtaća" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 8));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže aktivnost posle škole na engleskom. Zaokruži odgovarajuću sličicu! 🎨",
        teacherNote: "Izgovorite aktivnost 2–3 puta. Deca zaokružuju sličicu.",
        items,
      };
    },
  ...
  // ── Grade 4 curriculum additions (batch 4b) ─────────────────────────────
  g4_transport: {
    generate(count) {
      const all = [
        { word: "car", emoji: "🚗", sr: "auto" }, { word: "bus", emoji: "🚌", sr: "autobus" },
        { word: "train", emoji: "🚂", sr: "voz" }, { word: "bicycle", emoji: "🚲", sr: "bicikl" },
        { word: "plane", emoji: "✈️", sr: "avion" }, { word: "boat", emoji: "🚢", sr: "brod" },
        { word: "motorbike", emoji: "🏍️", sr: "motor" }, { word: "taxi", emoji: "🚕", sr: "taksi" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 8));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže prevozno sredstvo na engleskom. Zaokruži odgovarajuću sličicu! 🚌",
        teacherNote: "Izgovorite reč 2–3 puta. Deca zaokružuju sličicu.",
        items,
      };
    },
  ...
  g4_seasons_weather_times: {
    generate(count) {
      ...
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže godišnje doba ili doba dana na engleskom. Zaokruži odgovarajuću sličicu! ☀️",
        teacherNote: "Izgovorite reč 2–3 puta. Deca zaokružuju sličicu.",
        items,
      };
    },
  ...
  g4_question_words: {
    generate(count) {
      const pool = shuffle([
        { sentence: "___ is your best friend?", answer: "Who" },
        { sentence: "___ is your favourite colour?", answer: "What" },
        { sentence: "___ do you live?", answer: "Where" },
        { sentence: "___ is your birthday?", answer: "When" },
        { sentence: "___ are you today?", answer: "How" },
        { sentence: "___ is that boy?", answer: "Who" },
        { sentence: "___ time is it?", answer: "What" },
        { sentence: "___ is the nearest shop?", answer: "Where" },
      ]).slice(0, Math.min(count, 8));
      return {
        type: "fillin",
        instruction: "Popuni rečenicu odgovarajućom upitnom rečju (Who, What, Where, When, How).",
        wordBank: ["Who", "What", "Where", "When", "How"],
        items: pool,
      };
    },
  },

  g4_subject_object_pronouns: {
    generate(count) {
      const pool = shuffle([
        { sentence: "I like her. She likes ___.", answer: "me" },
        { sentence: "We see them. They see ___.", answer: "us" },
        { sentence: "He helps me. I help ___.", answer: "him" },
        { sentence: "You call her. She calls ___.", answer: "you" },
        { sentence: "They know us. We know ___.", answer: "them" },
        { sentence: "She loves him. He loves ___.", answer: "her" },
      ]).slice(0, Math.min(count, 6));
      return {
        type: "fillin",
        instruction: "Popuni rečenicu odgovarajućom objekatskom zamenicom (me/us/him/you/them/her).",
        wordBank: ["me", "us", "him", "you", "them", "her"],
        items: pool,
      };
    },
  },

  g4_prepositions_time: {
    generate(count) {
      const pool = shuffle([
        { sentence: "My birthday is ___ June.", answer: "in" },
        { sentence: "The party starts ___ 6 o'clock.", answer: "at" },
        { sentence: "We go to school ___ Monday.", answer: "on" },
        { sentence: "I was born ___ 2015.", answer: "in" },
        { sentence: "We have lunch ___ noon.", answer: "at" },
        { sentence: "School starts ___ September.", answer: "in" },
        { sentence: "We don't have school ___ Sunday.", answer: "on" },
        { sentence: "The film starts ___ 8 pm.", answer: "at" },
      ]).slice(0, Math.min(count, 8));
      return {
        type: "fillin",
        instruction: 'Popuni rečenicu sa "at", "in" ili "on".',
        wordBank: ["at", "in", "on"],
        items: pool,
      };
    },
  ...
  g4_places_in_town: {
    generate(count) {
      const all = [
        { word: "post office", emoji: "📮", sr: "pošta" }, { word: "supermarket", emoji: "🛒", sr: "supermarket" },
        { word: "swimming pool", emoji: "🏊", sr: "bazen" }, { word: "playground", emoji: "🛝", sr: "igralište" },
        { word: "petrol station", emoji: "⛽", sr: "benzinska pumpa" }, { word: "bakery", emoji: "🥖", sr: "pekara" },
        { word: "pharmacy", emoji: "💊", sr: "apoteka" }, { word: "church", emoji: "⛪", sr: "crkva" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 8));
      return {
        type: "listen-circle",
  ...
  g4_clothes: {
    ...
    generate(count, taskType) {
      const pairs = shuffle([
        { en: "pyjamas", sr: "pidžama" },
        { en: "swimsuit", sr: "kupaći kostim" },
        { en: "raincoat", sr: "kišni mantil" },
        { en: "sweater", sr: "džemper" },
        { en: "belt", sr: "kaiš" },
        { en: "tie", sr: "kravata" },
        { en: "sandals", sr: "sandale" },
        { en: "sunglasses", sr: "naočare za sunce" },
      ]).slice(0, Math.min(count, 8));
      if (taskType === "tf") return makeTFFromPairs(pairs, count);
      return {
        type: "match",
  ...
  g4_directions: {
    generate(count) {
      const all = [
        { word: "left", emoji: "⬅️", sr: "levo" }, { word: "right", emoji: "➡️", sr: "desno" },
        { word: "straight ahead", emoji: "⬆️", sr: "pravo" }, { word: "turn", emoji: "🔄", sr: "skrenuti" },
        { word: "stop", emoji: "🛑", sr: "stani" }, { word: "cross", emoji: "🚸", sr: "pređi (ulicu)" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 6));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže smer na engleskom. Zaokruži odgovarajuću sličicu! 🧭",
        teacherNote: "Izgovorite reč 2–3 puta. Deca zaokružuju sličicu i mogu pokazati smer rukom.",
        items,
      };
    },
  },

  g4_months_celebrations: {
    generate(count) {
      const all = [
        { word: "January", emoji: "🎊", sr: "januar" }, { word: "February", emoji: "💝", sr: "februar" },
        { word: "March", emoji: "🌱", sr: "mart" }, { word: "April", emoji: "🌧️", sr: "april" },
        { word: "May", emoji: "🌸", sr: "maj" }, { word: "June", emoji: "☀️", sr: "jun" },
        { word: "July", emoji: "🏖️", sr: "jul" }, { word: "August", emoji: "🌻", sr: "avgust" },
        { word: "September", emoji: "🍎", sr: "septembar" }, { word: "October", emoji: "🎃", sr: "oktobar" },
        { word: "November", emoji: "🍂", sr: "novembar" }, { word: "December", emoji: "🎄", sr: "decembar" },
        { word: "birthday", emoji: "🎂", sr: "rođendan" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 12));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže mesec ili praznik na engleskom. Zaokruži odgovarajuću sličicu! 🎉",
        teacherNote: "Izgovorite reč 2–3 puta. Deca zaokružuju sličicu.",
        items,
      };
    },
  ...
  g4_adverbs_frequency: {
    generate(count) {
      const pool = shuffle([
        { sentence: "I ___ brush my teeth every morning. (100%)", answer: "always" },
        { sentence: "She ___ eats meat. (0%)", answer: "never" },
        { sentence: "We ___ go to school by bus. (90%)", answer: "usually" },
        { sentence: "They ___ play chess on Sundays. (50%)", answer: "sometimes" },
        { sentence: "He ___ reads before bed. (70%)", answer: "often" },
        { sentence: "I ___ am late for school. (10%)", answer: "rarely" },
      ]).slice(0, Math.min(count, 6));
      return {
        type: "fillin",
        instruction: "Popuni rečenicu prilogom za učestalost (always/usually/often/sometimes/rarely/never).",
        wordBank: ["always", "usually", "often", "sometimes", "rarely", "never"],
        items: pool,
      };
    },
  },
  ...
  g4_ordinal_numbers: {
    generate(count) {
      const all = [
        { word: "first", emoji: "🥇", sr: "prvi" }, { word: "second", emoji: "🥈", sr: "drugi" },
        { word: "third", emoji: "🥉", sr: "treći" }, { word: "fourth", emoji: "4️⃣", sr: "četvrti" },
        { word: "fifth", emoji: "5️⃣", sr: "peti" }, { word: "sixth", emoji: "6️⃣", sr: "šesti" },
        { word: "seventh", emoji: "7️⃣", sr: "sedmi" }, { word: "eighth", emoji: "8️⃣", sr: "osmi" },
        { word: "ninth", emoji: "9️⃣", sr: "deveti" }, { word: "tenth", emoji: "🔟", sr: "deseti" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 10));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže redni broj na engleskom. Zaokruži odgovarajući broj! 🥇",
        teacherNote: "Izgovorite redni broj 2–3 puta. Deca zaokružuju odgovarajuću sličicu.",
        items,
      };
    },
  },
  ...
  g4_school_subjects: {
    generate(count) {
      const all = [
        { word: "math", emoji: "➗", sr: "matematika" }, { word: "English", emoji: "🇬🇧", sr: "engleski" },
        { word: "science", emoji: "🔬", sr: "priroda i društvo" }, { word: "art", emoji: "🎨", sr: "likovno" },
        { word: "music", emoji: "🎵", sr: "muzika" }, { word: "PE", emoji: "🤸", sr: "fizičko" },
        { word: "history", emoji: "📜", sr: "istorija" }, { word: "geography", emoji: "🌍", sr: "geografija" },
      ];
      const items = shuffle(all).slice(0, Math.min(count, 8));
      return {
        type: "listen-circle",
        instruction: "Nastavnik kaže školski predmet na engleskom. Zaokruži odgovarajuću sličicu! 📖",
        teacherNote: "Izgovorite predmet 2–3 puta. Deca zaokružuju sličicu.",
        items,
      };
    },
  },
